...
<head>
    ...
    <title>Cinema School In A Sandook</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light  fixed-top d-flex justify-content-between">
        <a class="navbar-brand film-library-logo" href="<?php echo base_url() ?>">
            <img  src="<?php echo base_url('assets/img/home/CSIAS.png'); ?>" alt="Film-librayr-logo">
        </a>
        <a href="<?php echo base_url("user") ?>" style="color:#fff; float:right">Login</a>
